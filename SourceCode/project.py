...
def cal():
    ...
    Label(root1,text='1.Number:',font='times 17',bg='#ADD8E6',width=13,height=3,anchor=W).grid(row=1,column=0,columnspan=2)
    Label(root1,text='2.Number:',font='times 17',bg='#ADD8E6',width=13,height=3,anchor=W).grid(row=2,column=0,columnspan=2)
    Label(root1,text='Result:',font='times 17',bg='#ADD8E6',width=13,height=3,anchor=W).grid(row=3,column=0,columnspan=2)
    e1=Entry(root1,font='arial 13 bold',width=40,bd=5)
    e1.grid(row=1,column=2,columnspan=2)
    e2=Entry(root1,font='arial 13 bold',width=38,bd=5)
    e2.grid(row=2,column=2,columnspan=2)
    e3=Entry(root1,font='arial 13 bold',width=38,bd=5)
...
def con():
    ...
    Label(root2,text='Binary Conversion',font='arial 20 bold',bg='#ADD8E6').grid(row=0,column=0,columnspan=4)
